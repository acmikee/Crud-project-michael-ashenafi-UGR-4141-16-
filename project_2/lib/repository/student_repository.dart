...
class StudentRepository {
  ...
  Future<Student> addStudent(Student student) => _apiService.createStudent(student);
  Future<Student> editStudent(Student student) => _apiService.updateStudent(student);
